...
const checks = [
  ...
  "Sermons that play without buffering on cell data",
  "Forms (prayer, contact) that fill out painlessly on a phone keyboard",
  "Loads fast on a slow connection in the church parking lot",
];

export default function MobileFriendly() {
  return (
    <section id="mobile" className="py-28 bg-warm-white">
      <div className="max-w-7xl mx-auto px-6">
        <SectionBadge
          number={21}
          name="Mobile Friendly"
          purpose="Why your church site has to look great on a phone — and how this one does"
        />
          ...
          <AnimateOnScroll>
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-text-dark leading-snug mb-5">
                Most People Will Find Your Church <em className="text-brown-light italic">From a Phone.</em>
              </h2>
              <p className="text-lg text-text-body leading-relaxed mb-8">
                The young family driving past on Sunday morning, the visitor looking up service
                times the night before, the new neighbor searching &ldquo;churches near me&rdquo; — they&rsquo;re
                all on a phone. If your site doesn&rsquo;t work there, you&rsquo;ve already lost them.
              </p>

              {/* Stats */}
              <div className="grid grid-cols-3 gap-4 mb-8 p-5 bg-cream rounded-2xl border border-cream-dark">
                {stats.map((s) => (
            ...
            <div className="flex justify-center">
              <div className="relative">
                ...
                <div className="relative w-[280px] h-[560px] rounded-[3rem] bg-brown-deep p-3 shadow-2xl">
                  ...
                  {/* Screen */}
                  <div className="relative w-full h-full rounded-[2.25rem] overflow-hidden bg-gradient-to-br from-brown via-brown-deep to-burgundy-dark">
                    {/* Status bar */}
