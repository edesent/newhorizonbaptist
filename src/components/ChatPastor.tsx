  ...
  return (
    <section id="chat" className="relative py-28 bg-cream">
      <div className="max-w-5xl mx-auto px-6">
        <SectionBadge
          number={20}
          name="Chat With the Pastor"
          purpose="A floating widget that lets visitors message the pastor directly"
        />
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-text-dark leading-snug mb-5">
                Talk Directly With <em className="text-brown-light italic">Pastor [Name].</em>
              </h2>
            ...
            <div className="relative">
              <div className="bg-warm-white rounded-3xl shadow-xl border border-cream-dark overflow-hidden">
                <div className="bg-brown-deep px-5 py-4 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gold flex items-center justify-center text-brown-deep font-serif font-bold">
                    P
                  </div>
                  <div className="flex-grow">
                    <p className="text-sm font-semibold text-white leading-tight">Pastor [Name]</p>
                  ...
                  {open && (
                    <div className="flex items-start justify-end gap-2">
                      <div className="max-w-[80%] bg-brown-light text-white text-sm rounded-2xl rounded-tr-sm px-4 py-2.5 leading-relaxed">
                        Hi pastor — what time does the service start on Sunday?
                      </div>
                    </div>
                  )}
                </div>
