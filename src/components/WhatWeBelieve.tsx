...
const beliefs = [
  ...
  { title: "Salvation", body: "By grace, through faith in the Lord Jesus Christ alone — not of works, lest any man should boast." },
  { title: "The Church", body: "Local, autonomous, Baptist — gathered to worship, edify believers, and preach the Gospel." },
];
