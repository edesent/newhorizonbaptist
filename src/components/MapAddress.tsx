        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-10 items-stretch">
              ...
              <div className="space-y-5 mb-8 flex-grow">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-dark font-medium">8505 S Street Rd<br />Port Byron, NY 13140</p>
                  </div>
                </div>
          ...
          <AnimateOnScroll delay={200}>
            <div className="h-full min-h-[400px] rounded-2xl overflow-hidden shadow-sm border border-cream-dark relative bg-cream-dark">
              <iframe
                title="Map to New Horizon Baptist Church"
                src="https://www.google.com/maps?q=8505+S+Street+Rd+Port+Byron+NY+13140&output=embed"
